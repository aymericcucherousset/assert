...
class AssertTest extends TestCase
{
    ...
    public static function getTests(): array
    {
        ...
        return [
            ...
            ['isListOf', [[new stdClass(), new stdClass()], 'stdClass'], true],
            ['isListOf', [[], 'stdClass'], true],
            ['isListOf', [[new stdClass(), new Exception()], 'stdClass'], false],
            ['isListOf', [['foo' => new stdClass()], 'stdClass'], false],
            ['isListOf', [[0 => new stdClass(), 2 => new stdClass()], 'stdClass'], false],
            ['isListOf', [true, 'stdClass'], false],
            ['isNonEmptyListOf', [[new stdClass(), new stdClass()], 'stdClass'], true],
            ['isNonEmptyListOf', [[], 'stdClass'], false],
            ['isNonEmptyListOf', [[new stdClass(), new Exception()], 'stdClass'], false],
            ['isNonEmptyListOf', [['foo' => new stdClass()], 'stdClass'], false],
            ['isNonEmptyListOf', [true, 'stdClass'], false],
